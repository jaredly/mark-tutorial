...
app.timers.check_ival = (function app$timers$check_ival(state,p__15141){
var vec__15143 = p__15141;
var name = cljs.core.nth.call(null,vec__15143,(0),null);
var timer = cljs.core.nth.call(null,vec__15143,(1),null);
if(cljs.core.not.call(null,app.timers.timer_ready.call(null,timer))){
return state;
} else {
var or__4247__auto__ = new cljs.core.Keyword(null,"handler","handler",-195596612).cljs$core$IFn$_invoke$arity$1(timer).call(null,state);
...
return cljs.core.assoc.call(null,options,new cljs.core.Keyword(null,"update","update",1045576396),(function (p1__15144_SHARP_){
return app.timers.update_fn.call(null,new cljs.core.Keyword(null,"update","update",1045576396).cljs$core$IFn$_invoke$arity$1(options),p1__15144_SHARP_);
}));
});
