...
var G__9989 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__9989;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__9991 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__9991,ch);
...
if(("\\" === ch__$1)){
var ch_9992__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_9992__$2 == null)){
cljs.tools.reader.reader_types.reader_error.call(null,rdr,"EOF while reading regex");
} else {
}

sb.append(ch_9992__$2);
} else {
}

var G__9993 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__9993;
continue;
}
}
...
var args9994 = [];
var len__5286__auto___9997 = arguments.length;
var i__5287__auto___9998 = (0);
while(true){
if((i__5287__auto___9998 < len__5286__auto___9997)){
args9994.push((arguments[i__5287__auto___9998]));

var G__9999 = (i__5287__auto___9998 + (1));
i__5287__auto___9998 = G__9999;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args9994.length)].join('')));
...
var vec__10006 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__10006,(0),null);
var start_column = cljs.core.nth.call(null,vec__10006,(1),null);
...
var G__10007 = cljs.core.conj_BANG_.call(null,a,form);
a = G__10007;
continue;
}
}
...
var _STAR_read_delim_STAR_10009 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_10009;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__10012 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__10012,(0),null);
var start_column = cljs.core.nth.call(null,vec__10012,(1),null);
var the_list = cljs.tools.reader.read_delimited.call(null,")",rdr,opts,pending_forms);
var vec__10013 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__10013,(0),null);
var end_column = cljs.core.nth.call(null,vec__10013,(1),null);
...
var vec__10016 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__10016,(0),null);
var start_column = cljs.core.nth.call(null,vec__10016,(1),null);
var the_vector = cljs.tools.reader.read_delimited.call(null,"]",rdr,opts,pending_forms);
var vec__10017 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__10017,(0),null);
var end_column = cljs.core.nth.call(null,vec__10017,(1),null);
...
var vec__10020 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__10020,(0),null);
var start_column = cljs.core.nth.call(null,vec__10020,(1),null);
...
var vec__10021 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__10021,(0),null);
var end_column = cljs.core.nth.call(null,vec__10021,(1),null);
...
var sb = (function (){var G__10024 = (new goog.string.StringBuffer());
G__10024.append(initch);
...
var G__10026 = (function (){var G__10025 = sb;
G__10025.append(ch);
...
switch (G__10034) {
case "\\":
var G__10038 = (function (){var G__10035 = sb;
G__10035.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__10035;
})();
var G__10039 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__10038;
ch = G__10039;
continue;
...
break;
default:
var G__10040 = (function (){var G__10036 = sb;
G__10036.append(ch);

return G__10036;
})();
var G__10041 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__10040;
ch = G__10041;
continue;
...
var vec__10046 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__10046,(0),null);
var column = cljs.core.nth.call(null,vec__10046,(1),null);
...
var vec__10055 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__10055,(0),null);
var column = cljs.core.nth.call(null,vec__10055,(1),null);
...
var vec__10064 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__10064,(0),null);
var end_column = cljs.core.nth.call(null,vec__10064,(1),null);
...
var G__10066 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__10066,true,null,opts,pending_forms);
...
var _STAR_suppress_read_STAR_10068 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_10068;
}});
...
var G__10070 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__10070,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__10070,rdr,first_line);
...
var G__10075 = matched;
var G__10076 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__10075;
finished = G__10076;
continue;
} else {
...
var arg_env10081 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__10082 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__10082,"(");
...
var G__10083 = (i + (1));
var G__10084 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4247__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4247__auto__)){
return or__4247__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env10081;
}});
/**
...
var ch = temp__4423__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__10086 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__10086);
...
var G__10089 = cljs.core.next.call(null,s);
var G__10090 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__10089;
key_vals = G__10090;
continue;
} else {
...
var gensym_env10098 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env10098;
}});
...
var args10105 = [];
var len__5286__auto___10109 = arguments.length;
var i__5287__auto___10110 = (0);
while(true){
if((i__5287__auto___10110 < len__5286__auto___10109)){
args10105.push((arguments[i__5287__auto___10110]));

var G__10111 = (i__5287__auto___10110 + (1));
i__5287__auto___10110 = G__10111;
continue;
} else {
}
break;
...
}catch (e10108){if((e10108 instanceof Error)){
var e = e10108;
...
var args10113 = [];
var len__5286__auto___10119 = arguments.length;
var i__5287__auto___10120 = (0);
while(true){
if((i__5287__auto___10120 < len__5286__auto___10119)){
args10113.push((arguments[i__5287__auto___10120]));

var G__10121 = (i__5287__auto___10120 + (1));
i__5287__auto___10120 = G__10121;
continue;
} else {
}
break;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__10116,reader){
var map__10117 = p__10116;
var map__10117__$1 = ((((!((map__10117 == null)))?((((map__10117.cljs$lang$protocol_mask$partition0$ & (64))) || (map__10117.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__10117):map__10117);
var opts = map__10117__$1;
var eof = cljs.core.get.call(null,map__10117__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var args10123 = [];
var len__5286__auto___10126 = arguments.length;
var i__5287__auto___10127 = (0);
while(true){
if((i__5287__auto___10127 < len__5286__auto___10126)){
args10123.push((arguments[i__5287__auto___10127]));

var G__10128 = (i__5287__auto___10127 + (1));
i__5287__auto___10127 = G__10128;
continue;
} else {
}
break;
