...
var len__5286__auto___10056 = arguments.length;
var i__5287__auto___10057 = (0);
while(true){
if((i__5287__auto___10057 < len__5286__auto___10056)){
args__5293__auto__.push((arguments[i__5287__auto___10057]));

var G__10058 = (i__5287__auto___10057 + (1));
i__5287__auto___10057 = G__10058;
continue;
} else {
}
break;
...
devtools.core.log_exception_if_avail.cljs$lang$applyTo = (function (seq10055){
return devtools.core.log_exception_if_avail.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq10055));
});
devtools.core.monitor_api_calls = (function devtools$core$monitor_api_calls(name,api_call){
return (function() { 
var G__10059__delegate = function (args){
...
while (G__10060__i < G__10060__a.length) {G__10060__a[G__10060__i] = arguments[G__10060__i + 0]; ++G__10060__i;}
  args = new cljs.core.IndexedSeq(G__10060__a,0);
} 
...
return (function() { 
var G__10064__delegate = function (args){
...
while (G__10065__i < G__10065__a.length) {G__10065__a[G__10065__i] = arguments[G__10065__i + 0]; ++G__10065__i;}
  args = new cljs.core.IndexedSeq(G__10065__a,0);
} 
...
if(devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"legacy-formatter","legacy-formatter",-1954119499))){
...
if(devtools.core.installed_QMARK_.call(null)){
...
if(devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"install-sanity-hints","install-sanity-hints",72546145))){
