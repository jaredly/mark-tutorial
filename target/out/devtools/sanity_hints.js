...
var reader = (function (){var or__4247__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__4247__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__4247__auto__)){
return or__4247__auto__;
} else {
return (128);
...
var file = cljs.core.get.call(null,map__10186__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__10186__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__10186__$1,new cljs.core.Keyword(null,"column","column",2078222095));
...
var temp__4425__auto___10188 = devtools.sanity_hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4425__auto___10188)){
var sense_10189 = temp__4425__auto___10188;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_10189)].join('');
} else {
}
}
} else {
