...
var vec__11440 = axis;
var a_x = cljs.core.nth.call(null,vec__11440,(0),null);
var a_y = cljs.core.nth.call(null,vec__11440,(1),null);
var a_z = cljs.core.nth.call(null,vec__11440,(2),null);
var vec__11441 = v;
var x = cljs.core.nth.call(null,vec__11441,(0),null);
var y = cljs.core.nth.call(null,vec__11441,(1),null);
var z = cljs.core.nth.call(null,vec__11441,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__11442,p__11443){
var vec__11446 = p__11442;
var u1 = cljs.core.nth.call(null,vec__11446,(0),null);
var u2 = cljs.core.nth.call(null,vec__11446,(1),null);
var u3 = cljs.core.nth.call(null,vec__11446,(2),null);
var vec__11447 = p__11443;
var v1 = cljs.core.nth.call(null,vec__11447,(0),null);
var v2 = cljs.core.nth.call(null,vec__11447,(1),null);
var v3 = cljs.core.nth.call(null,vec__11447,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__11448_SHARP_){
return (p1__11448_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__11449_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__11450_SHARP_,angle_lr),angle_ud);
...
var map__11457 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__11457__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__11457__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4423__auto__ = (function (){var pred__11459 = cljs.core._EQ_;
var expr__11460 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__11459.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__11460))){
return straight;
} else {
if(cljs.core.truth_(pred__11459.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__11460))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__11459.call(null,quil.middlewares.navigation_3d.space,expr__11460))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__11459.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__11460))){
return up;
} else {
if(cljs.core.truth_(pred__11459.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__11460))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__11459.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__11460))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4423__auto__,map__11457,map__11457__$1,up,straight){
return (function (p1__11451_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__11451_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4423__auto__,map__11457,map__11457__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__11462_SHARP_);
});})(initial_state))
);
});
/**
...
var map__11468_11473 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__11468_11474__$1 = ((((!((map__11468_11473 == null)))?((((map__11468_11473.cljs$lang$protocol_mask$partition0$ & (64))) || (map__11468_11473.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__11468_11473):map__11468_11473);
var vec__11469_11475 = cljs.core.get.call(null,map__11468_11474__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_11476 = cljs.core.nth.call(null,vec__11469_11475,(0),null);
var c_y_11477 = cljs.core.nth.call(null,vec__11469_11475,(1),null);
var c_z_11478 = cljs.core.nth.call(null,vec__11469_11475,(2),null);
var vec__11470_11479 = cljs.core.get.call(null,map__11468_11474__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_11480 = cljs.core.nth.call(null,vec__11470_11479,(0),null);
var u_y_11481 = cljs.core.nth.call(null,vec__11470_11479,(1),null);
var u_z_11482 = cljs.core.nth.call(null,vec__11470_11479,(2),null);
var vec__11471_11483 = cljs.core.get.call(null,map__11468_11474__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_11484 = cljs.core.nth.call(null,vec__11471_11483,(0),null);
var p_y_11485 = cljs.core.nth.call(null,vec__11471_11483,(1),null);
var p_z_11486 = cljs.core.nth.call(null,vec__11471_11483,(2),null);
quil.core.camera.call(null,p_x_11484,p_y_11485,p_z_11486,(p_x_11484 + c_x_11476),(p_y_11485 + c_y_11477),(p_z_11486 + c_z_11478),u_x_11480,u_y_11481,u_z_11482);
