...
var vec__11454 = axis;
var a_x = cljs.core.nth.call(null,vec__11454,(0),null);
var a_y = cljs.core.nth.call(null,vec__11454,(1),null);
var a_z = cljs.core.nth.call(null,vec__11454,(2),null);
var vec__11455 = v;
var x = cljs.core.nth.call(null,vec__11455,(0),null);
var y = cljs.core.nth.call(null,vec__11455,(1),null);
var z = cljs.core.nth.call(null,vec__11455,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__11456,p__11457){
var vec__11460 = p__11456;
var u1 = cljs.core.nth.call(null,vec__11460,(0),null);
var u2 = cljs.core.nth.call(null,vec__11460,(1),null);
var u3 = cljs.core.nth.call(null,vec__11460,(2),null);
var vec__11461 = p__11457;
var v1 = cljs.core.nth.call(null,vec__11461,(0),null);
var v2 = cljs.core.nth.call(null,vec__11461,(1),null);
var v3 = cljs.core.nth.call(null,vec__11461,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__11462_SHARP_){
return (p1__11462_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__11463_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__11464_SHARP_,angle_lr),angle_ud);
...
var map__11471 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__11471__$1 = ((((!((map__11471 == null)))?((((map__11471.cljs$lang$protocol_mask$partition0$ & (64))) || (map__11471.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__11471):map__11471);
var up = cljs.core.get.call(null,map__11471__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__11471__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4423__auto__ = (function (){var pred__11473 = cljs.core._EQ_;
var expr__11474 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__11473.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__11474))){
return straight;
} else {
if(cljs.core.truth_(pred__11473.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__11474))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__11473.call(null,quil.middlewares.navigation_3d.space,expr__11474))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__11473.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__11474))){
return up;
} else {
if(cljs.core.truth_(pred__11473.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__11474))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__11473.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__11474))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4423__auto__,map__11471,map__11471__$1,up,straight){
return (function (p1__11465_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__11465_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4423__auto__,map__11471,map__11471__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__11476_SHARP_);
});})(initial_state))
);
});
/**
...
var map__11482_11487 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__11482_11488__$1 = ((((!((map__11482_11487 == null)))?((((map__11482_11487.cljs$lang$protocol_mask$partition0$ & (64))) || (map__11482_11487.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__11482_11487):map__11482_11487);
var vec__11483_11489 = cljs.core.get.call(null,map__11482_11488__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_11490 = cljs.core.nth.call(null,vec__11483_11489,(0),null);
var c_y_11491 = cljs.core.nth.call(null,vec__11483_11489,(1),null);
var c_z_11492 = cljs.core.nth.call(null,vec__11483_11489,(2),null);
var vec__11484_11493 = cljs.core.get.call(null,map__11482_11488__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_11494 = cljs.core.nth.call(null,vec__11484_11493,(0),null);
var u_y_11495 = cljs.core.nth.call(null,vec__11484_11493,(1),null);
var u_z_11496 = cljs.core.nth.call(null,vec__11484_11493,(2),null);
var vec__11485_11497 = cljs.core.get.call(null,map__11482_11488__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_11498 = cljs.core.nth.call(null,vec__11485_11497,(0),null);
var p_y_11499 = cljs.core.nth.call(null,vec__11485_11497,(1),null);
var p_z_11500 = cljs.core.nth.call(null,vec__11485_11497,(2),null);
quil.core.camera.call(null,p_x_11498,p_y_11499,p_z_11500,(p_x_11498 + c_x_11490),(p_y_11499 + c_y_11491),(p_z_11500 + c_z_11492),u_x_11494,u_y_11495,u_z_11496);
