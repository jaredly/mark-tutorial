...
var vec__10170 = axis;
var a_x = cljs.core.nth.call(null,vec__10170,(0),null);
var a_y = cljs.core.nth.call(null,vec__10170,(1),null);
var a_z = cljs.core.nth.call(null,vec__10170,(2),null);
var vec__10171 = v;
var x = cljs.core.nth.call(null,vec__10171,(0),null);
var y = cljs.core.nth.call(null,vec__10171,(1),null);
var z = cljs.core.nth.call(null,vec__10171,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__10172,p__10173){
var vec__10176 = p__10172;
var u1 = cljs.core.nth.call(null,vec__10176,(0),null);
var u2 = cljs.core.nth.call(null,vec__10176,(1),null);
var u3 = cljs.core.nth.call(null,vec__10176,(2),null);
var vec__10177 = p__10173;
var v1 = cljs.core.nth.call(null,vec__10177,(0),null);
var v2 = cljs.core.nth.call(null,vec__10177,(1),null);
var v3 = cljs.core.nth.call(null,vec__10177,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__10178_SHARP_){
return (p1__10178_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__10179_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__10180_SHARP_,angle_lr),angle_ud);
...
var map__10187 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__10187__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__10187__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4423__auto__ = (function (){var pred__10189 = cljs.core._EQ_;
var expr__10190 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__10189.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__10190))){
return straight;
} else {
if(cljs.core.truth_(pred__10189.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__10190))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__10189.call(null,quil.middlewares.navigation_3d.space,expr__10190))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__10189.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__10190))){
return up;
} else {
if(cljs.core.truth_(pred__10189.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__10190))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__10189.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__10190))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4423__auto__,map__10187,map__10187__$1,up,straight){
return (function (p1__10181_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__10181_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4423__auto__,map__10187,map__10187__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__10192_SHARP_);
});})(initial_state))
);
});
/**
...
var map__10198_10203 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__10198_10204__$1 = ((((!((map__10198_10203 == null)))?((((map__10198_10203.cljs$lang$protocol_mask$partition0$ & (64))) || (map__10198_10203.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__10198_10203):map__10198_10203);
var vec__10199_10205 = cljs.core.get.call(null,map__10198_10204__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_10206 = cljs.core.nth.call(null,vec__10199_10205,(0),null);
var c_y_10207 = cljs.core.nth.call(null,vec__10199_10205,(1),null);
var c_z_10208 = cljs.core.nth.call(null,vec__10199_10205,(2),null);
var vec__10200_10209 = cljs.core.get.call(null,map__10198_10204__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_10210 = cljs.core.nth.call(null,vec__10200_10209,(0),null);
var u_y_10211 = cljs.core.nth.call(null,vec__10200_10209,(1),null);
var u_z_10212 = cljs.core.nth.call(null,vec__10200_10209,(2),null);
var vec__10201_10213 = cljs.core.get.call(null,map__10198_10204__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_10214 = cljs.core.nth.call(null,vec__10201_10213,(0),null);
var p_y_10215 = cljs.core.nth.call(null,vec__10201_10213,(1),null);
var p_z_10216 = cljs.core.nth.call(null,vec__10201_10213,(2),null);
quil.core.camera.call(null,p_x_10214,p_y_10215,p_z_10216,(p_x_10214 + c_x_10206),(p_y_10215 + c_y_10207),(p_z_10216 + c_z_10208),u_x_10210,u_y_10211,u_z_10212);
