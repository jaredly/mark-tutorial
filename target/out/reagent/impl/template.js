...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__4826__auto__,writer__4827__auto__,opt__4828__auto__){
return cljs.core._write.call(null,writer__4827__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__4247__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__4247__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__4247__auto__)){
return or__4247__auto__;
} else {
...
var G__17020 = o;
(G__17020[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
while (G__17022__i < G__17022__a.length) {G__17022__a[G__17022__i] = arguments[G__17022__i + 0]; ++G__17022__i;}
  args = new cljs.core.IndexedSeq(G__17022__a,0);
} 
...
var old_17024 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_17024))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_17024)].join(''):class$));
} else {
}
...
if(cljs.core.not.call(null,(function (){var and__4235__auto__ = (node === document.activeElement);
if(and__4235__auto__){
var and__4235__auto____$1 = reagent.impl.template.has_selection_api_QMARK_.call(null,(node["type"]));
...
if(cljs.core.truth_((function (){var and__4235__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__17027 = jsprops;
(G__17027["defaultValue"] = value);

(G__17027["onChange"] = ((function (G__17027,v,value,on_change){
return (function (p1__17025_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__17025_SHARP_);
});})(G__17027,v,value,on_change))
);
...
var vec__17029 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__17029,(0),null);
var id = cljs.core.nth.call(null,vec__17029,(1),null);
var class$ = cljs.core.nth.call(null,vec__17029,(2),null);
...
var temp__4427__auto__ = (function (){var G__17033 = cljs.core.meta.call(null,v);
var G__17033__$1 = (((G__17033 == null))?null:reagent.impl.template.get_key.call(null,G__17033));
return G__17033__$1;
})();
if((temp__4427__auto__ == null)){
...
var jsprops = {"argv": v};
var G__17035_17036 = v;
var G__17035_17037__$1 = (((G__17035_17036 == null))?null:reagent.impl.template.key_from_vec.call(null,G__17035_17036));
var G__17035_17038__$2 = (((G__17035_17037__$1 == null))?null:(jsprops["key"] = G__17035_17037__$1));
...
var p = (function (){var temp__4427__auto__ = (function (){var G__17041 = cljs.core.meta.call(null,argv);
var G__17041__$1 = (((G__17041 == null))?null:reagent.impl.template.get_key.call(null,G__17041));
return G__17041__$1;
})();
if((temp__4427__auto__ == null)){
return jsprops;
...
var G__17042 = (((jsprops == null))?{}:jsprops);
(G__17042["key"] = key);
...
var G__17043 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__17043;
continue;
}
} else {
...
var n__5131__auto___17044 = a.length;
var i_17045 = (0);
while(true){
if((i_17045 < n__5131__auto___17044)){
(a[i_17045] = reagent.impl.template.as_element.call(null,(a[i_17045])));
...
var a = cljs.core.into_array.call(null,s);
var n__5131__auto___17047 = a.length;
var i_17048 = (0);
while(true){
if((i_17048 < n__5131__auto___17047)){
var val_17049 = (a[i_17048]);
if((cljs.core.vector_QMARK_.call(null,val_17049)) && ((reagent.impl.template.key_from_vec.call(null,val_17049) == null))){
(o["no-key"] = true);
} else {
}

(a[i_17048] = reagent.impl.template.as_element.call(null,val_17049));

var G__17050 = (i_17048 + (1));
i_17048 = G__17050;
continue;
} else {
}
...
if(cljs.core.truth_((function (){var and__4235__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__4235__auto__){
return (ctx["no-key"]);
} else {
return and__4235__auto__;
...
var G__17052 = (cljs.core.count.call(null,argv) - first_child);
switch (G__17052) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__17052){
